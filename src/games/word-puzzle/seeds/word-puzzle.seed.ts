...
export interface SeedWordPuzzleLevel {
  levelNumber: number;
  titleMg: string;
  titleFr: string;
  description: string;
...
export const INITIAL_WORD_PUZZLE_LEVELS: SeedWordPuzzleLevel[] = [
  {
    levelNumber: 1,
    ...
    sentences: [
      {
        ...
        hint: 'mitambatra',
        explanationMg:
          'Mampiseho fa ny firaisan-kina no herin’ny fiaraha-monina.',
        explanationFr:
  ...
  },
  {
    ...
    sentences: [
      ...
      },
      {
        ...
        hint: 'kely',
        explanationMg:
          'Fandavana ny fitarazohana sy ny fahanginana amin’ny asa.',
        explanationFr:
